 ...
 * @brief Ovladač OLED displeje s řadičem SSD1306 (128×64).
 *
 * Tento modul poskytuje funkce pro inicializaci OLED displeje, nastavení
 * kurzoru, výpis textu a práci s režimy znaků. Komunikace probíhá přes
 * sběrnici I2C pomocí TWI ovladače.
 *
 * @copyright 2016 Skie-Systems, Created by Michael Köhler, GPL license
 *
 * @{
 */
